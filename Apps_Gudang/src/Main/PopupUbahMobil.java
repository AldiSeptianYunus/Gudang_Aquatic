...
public class PopupUbahMobil extends javax.swing.JFrame {
    private Connection conn = new Koneksi().connect();
    private ButtonGroup buttonGroup1;
    private DefaultTableModel tabmode;
    private static Form_Mobil parentForm;

    public PopupUbahMobil(Form_Mobil parent) {
        initComponents();
    ...
    public void setData(String id, String plat, String nama, String jenis) {
    txtId.setText(id);
    ...
    public static void setParentForm(Form_Mobil parent) {
        parentForm = parent;
    }
    ...
    private void aktif() {
        ...
        cJenis.addItem("Truck");
        cJenis.addItem("Pick up");
    }
    /**
    ...
    private void initComponents() {
        ...
        navbarLayout.setHorizontalGroup(
            ...
            .addGroup(navbarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Barang, javax.swing.GroupLayout.DEFAULT_SIZE, 534, Short.MAX_VALUE))
        );
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        try {
            String sql = "UPDATE mobil SET plat_mobil=?, nama_driver=?, jenis=? WHERE id_mobil=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupUbahMobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupUbahMobil(null).setVisible(true);
            }
        });
    }
