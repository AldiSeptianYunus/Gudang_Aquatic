...
public class PopupTambahSupplier extends javax.swing.JFrame {
    
    private Connection conn = new Koneksi().connect();
    private ButtonGroup buttonGroup1;
    private static Form_Supplier parentForm;
    
    public PopupTambahSupplier(Form_Supplier parent) {
        initComponents();
        parentForm = parent;
        kosong();
        aktif();
    ...
    private void initComponents() {
        ...
        Barang.setText("Tambah Supplier");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupTambahSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupTambahSupplier(null).setVisible(true);
            }
        });
    }
