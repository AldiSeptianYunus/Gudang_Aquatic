...
public class Form_Barang_Keluar extends javax.swing.JPanel {
    ...
    private void setupSupplierCombo() {
        cToko.removeAllItems();
        cToko.addItem("Pilih Toko");
        
        try {
            String query = "SELECT id_toko, nama_toko FROM toko ORDER BY nama_toko";
            ...
            while (rs.next()) {
                ...
                cToko.addItem(idToko + " - " + namaToko);
            }
            
            rs.close();
            pst.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Error mengambil data toko: " + e.getMessage());
        }
    }
    ...
    protected void autonumber() {
        try {
            String sql = "SELECT id_keluar FROM barang_keluar ORDER BY id_keluar DESC LIMIT 1";
            PreparedStatement pst = conn.prepareStatement(sql);
            ResultSet rs = pst.executeQuery();
            
            String nextId = "BK0001";
    ...
    protected void aktif() {
        ...
        tblTR_BrgKlr.setModel(tabmode);
        
        // Atur lebar kolom
        if (tblTR_BrgKlr.getColumnModel().getColumnCount() >= 3) {
            tblTR_BrgKlr.getColumnModel().getColumn(0).setPreferredWidth(100); // ID Barang
            tblTR_BrgKlr.getColumnModel().getColumn(1).setPreferredWidth(200); // Nama Barang
            tblTR_BrgKlr.getColumnModel().getColumn(2).setPreferredWidth(80);  // Jumlah
        }
    }

    protected void kosong() {
        
        if (cToko.getItemCount() > 0) {
            cToko.setSelectedIndex(0); 
        }
        txtNamaToko.setText("");
    ...
    private void initComponents() {
        ...
        cToko = new javax.swing.JComboBox<>();
        ...
        tblTR_BrgKlr = new javax.swing.JTable();
        ...
        cToko.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cToko.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cTokoItemStateChanged(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cToko, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtNamaToko, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(23, 23, 23))
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtFaktur, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                        .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtNamaToko, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTggl, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(cToko, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
        ...
        jIdTrans.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        Barang.setText("Transaksi Barang Keluar");
        ...
        tblTR_BrgKlr.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblTR_BrgKlr);
    ...
    private void bUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUbahActionPerformed
        int selectedRow = tblTR_BrgKlr.getSelectedRow();
        if (selectedRow == -1) {
    ...
    if (cToko.getSelectedIndex() == 0) {
        JOptionPane.showMessageDialog(this, "Pilih toko tujuan terlebih dahulu!");
        return;
    }
    ...
    try {
        ...
        String idKeluar = jIdTrans.getText().trim();
            String noFaktur = txtFaktur.getText().trim();
            Date tanggalKeluar = (Date) jTggl.getValue();
            java.sql.Date sqlDate = new java.sql.Date(tanggalKeluar.getTime());
            ...
            if (cToko.getSelectedIndex() > 0) {
                String selectedSupplier = cToko.getSelectedItem().toString();
                if (!selectedSupplier.equals("Pilih Toko")) {
                    idToko = selectedSupplier.split(" - ")[0];
                }
            }
            ...
            String sqlHeader = "INSERT INTO barang_keluar (id_keluar, no_faktur, tanggal_keluar, id_toko, id_mobil, id_user) VALUES (?, ?, ?, ?, ?, ?)";
            PreparedStatement pstHeader = conn.prepareStatement(sqlHeader);
            pstHeader.setString(1, idKeluar);
            pstHeader.setString(2, noFaktur);
            pstHeader.setDate(3, sqlDate);
            pstHeader.setString(4, idToko);
        ...
        for (String[] barang : daftarBarang) {
                ...
                String sqlDetail = "INSERT INTO detail_barang_keluar (id_keluar, id_barang, jumlah) VALUES (?, ?, ?)";
                PreparedStatement pstDetail = conn.prepareStatement(sqlDetail);
                pstDetail.setString(1, idKeluar);
            ...
            String sqlCheckStok = "SELECT jumlah FROM stok_barang WHERE id_barang = ?";
                ...
                if (rsCheck.next()) {
                    ...
                    throw new SQLException("Barang dengan ID " + idBarang + " tidak ditemukan dalam stok");
                }
    ...
    private void cTokoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cTokoItemStateChanged
        if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED
            && cToko.getSelectedItem() != null) {

            String selectedItem = cToko.getSelectedItem().toString();

            if (selectedItem.equals("Pilih Toko")) {
                txtNamaToko.setText("");
                return;
            }
            ...
            try {
                ...
                String sql = "SELECT nama_toko FROM toko WHERE id_toko = ?";
                PreparedStatement pst = conn.prepareStatement(sql);
                ...
                txtNamaToko.setText("");
                JOptionPane.showMessageDialog(null, "Error mengambil nama toko: " + e.getMessage());
            }
        }
    }//GEN-LAST:event_cTokoItemStateChanged
    ...
    private void bTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTambahActionPerformed
        try {
            PopupTambahKeluar popup = new PopupTambahKeluar(this);
    ...
    private javax.swing.JComboBox<String> cToko;
    ...
    private javax.swing.JTable tblTR_BrgKlr;
