...
public class PopupTambahMobil extends javax.swing.JFrame {
    private Connection conn = new Koneksi().connect();
    private ButtonGroup buttonGroup1;
    private static Form_Mobil parentForm;

    public PopupTambahMobil(Form_Mobil parent) {
        initComponents();
        parentForm = parent;
        setupCJenis();
        kosong();
    ...
    public static void setParentForm(Form_Mobil parent) {
        ...
        if (parentForm != null) {
            parentForm.datatable(); // Panggil method datatable() di Form_Barang
        }
    }
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        ...
        try {
            ...
            stat.setString(2, txtPlat.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupTambahMobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupTambahMobil(null).setVisible(true);
            }
        });
    }
