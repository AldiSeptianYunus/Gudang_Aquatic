...
public class PopupUbahSupplier extends javax.swing.JFrame {

    private Connection conn = new Koneksi().connect();
    private ButtonGroup buttonGroup1;
    private static Form_Supplier parentForm;
    
    public PopupUbahSupplier(Form_Supplier parent) {
        initComponents();
        parentForm = parent;
    ...
    public static void setParentForm(Form_Supplier parent) {
        parentForm = parent;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupUbahSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupUbahSupplier(null).setVisible(true);
            }
        });
    }
