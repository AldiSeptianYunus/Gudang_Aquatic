...
public class PopupTambahMasuk extends javax.swing.JFrame {
    private Connection conn = new Koneksi().connect();
    private ButtonGroup buttonGroup1;
    private static Form_Barang_Masuk parentForm;
    
    public PopupTambahMasuk(Form_Barang_Masuk parent) {
        initComponents();
        parentForm = parent;
        setupCIdBarang();
        kosong();
    ...
    public static void setParentForm(Form_Barang_Masuk parent) {
        parentForm = parent;
    }
    ...
    private void initComponents() {
        ...
        Barang.setText("Form Barang Masuk");

        javax.swing.GroupLayout navbarLayout = new javax.swing.GroupLayout(navbar);
        navbar.setLayout(navbarLayout);
        navbarLayout.setHorizontalGroup(
            navbarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Barang, javax.swing.GroupLayout.DEFAULT_SIZE, 539, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupTambahMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupTambahMasuk(null).setVisible(true);
            }
        });
    }
